        ...
        Promise.all([
            ...
            .then(([cpu_info, drive_info, os_info, memory_info, git]) => {
                const embed = new MessageEmbed() 
                    ...
                    .addField(`🐙 Latest commit`, `>>> **Git:** *[${git[0].sha}](${git[0].html_url})*\n**Time:** <t:${moment(git[0].commit.committer.date).unix()}:D> (<t:${moment(git[0].commit.committer.date).unix()}:R>)`)
                    .setFooter({
                        text: `Asked by ${interaction.member.nickname} || Embed graphics by Majo.exe`,
                ...
                const row = new MessageActionRow() 
                    ...
                    .addComponents(
                        new MessageButton() 
                            ...
                            .setEmoji("<:Bot:993821529123070013>")
                            .setLabel("Invite me")
                            .setStyle("LINK")
                    );
