...
module.exports.run = async (bot, message, args) => {
    ...
    const embed = new MessageEmbed()
        ...
        .setTitle(`💰 Portefeuille de ${member.user.username}`)
        .addField(`💳 Argent:`,`${user.coinsInWallet.toLocaleString()} :coin:`)
        .addField(`🏦 En Banque:`,`${user.coinsInBank.toLocaleString()} :coin: (**Espace banquaire restant:** ${bankspace_still} || **Espace banquaire total:** ${user.bankSpace})`)
        .addField(`🌐 Total de bénéfice:`,`${(user.coinsInWallet + user.coinsInBank).toLocaleString()} :coin:`)
