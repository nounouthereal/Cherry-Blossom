    ...
    run: async (bot, interaction, args) => {
        ...
        try {
            ...
            const embed = new MessageEmbed() 
                ...
                .setFooter({
                    text: `☠️ Kill • Asked by ${interaction.member.nickname || interaction.user.username}`,
                    iconURL: interaction.user.displayAvatarURL({
                        dynamic: true,
                        format: `png`,
                        size: 2048,
