...
module.exports = {
    //definition
        name: "fhelp", //the name of the command 
        category: "info", //the category this will be listed at, for the help cmd
        aliases: ["fortnitehelp", "fcommandinfo"], //every parameter can be an alias or empty for no aliases
        cooldown: 5, //this will set it to a 5 second cooldown
        usage: "fhelp [Command]", //this is for the help command for EACH cmd
...
const embed = new MessageEmbed() //defining the Embed
    ...
    .setTitle("HELP MENU")
    .setFooter(`TO see command descriptions and inforamtion, type: ${config.prefix}fhelp [CMD NAME]`, client.user.displayAvatarURL())
